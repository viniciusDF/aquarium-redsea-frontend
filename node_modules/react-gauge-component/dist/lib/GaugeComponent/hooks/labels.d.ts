...
export declare const addArcTicks: (gauge: Gauge, nextIndex?: () => number) => void;
...
export declare const addTick: (tick: Tick, gauge: Gauge, renderIndex?: number) => void;
 ...
 */
export declare const updateValueLabelText: (gauge: Gauge, currentValue: number) => void;
